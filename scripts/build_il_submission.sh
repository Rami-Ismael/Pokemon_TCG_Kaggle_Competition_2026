...
# Both overridable so any IL-lineage checkpoint can be bundled without
# editing this script, e.g.:
#   CHECKPOINT=models/il_agent_full_0804 BUNDLE=submissions/il_agent_full_0804 \
