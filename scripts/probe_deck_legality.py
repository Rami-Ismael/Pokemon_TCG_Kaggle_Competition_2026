...
def main() -> None:
    ...
    # Write name refs, not absolute paths: resolve_deck_ref finds a decklist
    # stem or agents/<name>/deck.csv in whatever checkout reads the manifest.
    # Absolute paths pin the manifest to the worktree that generated it, and
    # die with it (this happened: legal_*.txt pointed into a deleted worktree).
