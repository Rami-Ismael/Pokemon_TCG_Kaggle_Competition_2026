"""All-days imitation wrapper (plain-name scheme): il_agent inference core, checkpoint selfplay_g2/u1293312_final (self-play gen 2).
...
_CKPT = _REPO / "models" / "selfplay_g3" / "u1229824_final"
_CORE = _REPO / "agents" / "il_agent" / "agent_core.py"

_prev = os.environ.get("IL_MODEL_DIR")
os.environ["IL_MODEL_DIR"] = str(_CKPT)
try:
    _spec = importlib.util.spec_from_file_location("il_core_selfplay_g3_final", _CORE)
