"""S2v2 restarted-REWEIGHT arm wrapper: il_agent inference core, checkpoint e1_s44.

Same pattern as agents/s2_arms/: loads agents/il_agent/agent_core.py as a
private module with IL_MODEL_DIR pointed at models/s2v2/e1_s44, env var
