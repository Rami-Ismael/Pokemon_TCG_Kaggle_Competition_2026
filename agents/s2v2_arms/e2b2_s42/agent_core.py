"""S2v2 restarted-REWEIGHT arm wrapper: il_agent inference core, checkpoint e2b2_s42.

Same pattern as agents/s2_arms/: loads agents/il_agent/agent_core.py as a
private module with IL_MODEL_DIR pointed at models/s2v2/e2b2_s42, env var
