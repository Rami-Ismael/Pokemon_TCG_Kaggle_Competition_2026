"""S2v2 restarted-REWEIGHT arm wrapper: il_agent inference core, checkpoint efb_s43.

Same pattern as agents/s2_arms/: loads agents/il_agent/agent_core.py as a
private module with IL_MODEL_DIR pointed at models/s2v2/efb_s43, env var
