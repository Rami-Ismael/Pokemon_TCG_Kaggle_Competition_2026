"""IL checkpoint arm: il_agent inference core pointed at models/il_agent_small_combined.
...
_CKPT = _REPO / "models" / "il_agent_small_combined"
_CORE = _REPO / "agents" / "il_agent" / "agent_core.py"

_prev = os.environ.get("IL_MODEL_DIR")
os.environ["IL_MODEL_DIR"] = str(_CKPT)
try:
    _spec = importlib.util.spec_from_file_location("il_core_il_small_comb_2ep", _CORE)
