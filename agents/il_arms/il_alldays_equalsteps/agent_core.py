"""IL checkpoint arm: il_agent inference core pointed at models/il_alldays_equalsteps_0804.
...
_CKPT = _REPO / "models" / "il_alldays_equalsteps_0804"
_CORE = _REPO / "agents" / "il_agent" / "agent_core.py"

_prev = os.environ.get("IL_MODEL_DIR")
os.environ["IL_MODEL_DIR"] = str(_CKPT)
try:
    _spec = importlib.util.spec_from_file_location("il_core_il_alldays_equalsteps", _CORE)
